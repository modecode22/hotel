...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "relative flex h-full w-full flex-col overflow-hidden rounded-xl bg-background text-neutral-800",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3" cmdk-neutral-300-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-11 w-full rounded-xl bg-transparent py-3 text-sm outline-none placeholder:text-neutral-600 disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    />
