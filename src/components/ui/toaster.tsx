    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "group-[.toast]:bg-foreground group-[.toast]:text-neutral-100 group-[.toast]:rounded-xl",
          cancelButton:
            "group-[.toast]:bg-neutral-200 group-[.toast]:text-neutral-600 group-[.toast]:rounded-xl",
        },
      }}
      {...props}
    />
